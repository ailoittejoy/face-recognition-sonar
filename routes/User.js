const { login, register, updateImages } = require('../controllers/UserController');
...
router.post('/login', checkSchema(UserValidator.login), ErrorHandleHelper.requestValidator, login);
router.post(
	'/register',
